...
class matrix4x4math final : public matrixsquaremath
{
	...
	public:
		...
		virtual float* rotateX(float* out, char* matrix, float angle);
		virtual float* rotateX(float* out, short* matrix, float angle);
		virtual float* rotateX(float* out, int* matrix, float angle);
		virtual float* rotateX(float* out, long long* matrix, float angle);
		virtual float* rotateX(float* out, __int128* matrix, float angle);
		virtual float* rotateX(float* out, float* matrix, float angle);
		virtual double* rotateX(double* out, char* matrix, double angle);
		virtual double* rotateX(double* out, short* matrix, double angle);
		virtual double* rotateX(double* out, int* matrix, double angle);
		virtual double* rotateX(double* out, long long* matrix, double angle);
		virtual double* rotateX(double* out, __int128* matrix, double angle);
		virtual double* rotateX(double* out, float* matrix, double angle);
		virtual double* rotateX(double* out, double* matrix, double angle);
		virtual __float128* rotateX(__float128* out, char* matrix, __float128 angle);
		virtual __float128* rotateX(__float128* out, short* matrix, __float128 angle);
		virtual __float128* rotateX(__float128* out, int* matrix, __float128 angle);
		virtual __float128* rotateX(__float128* out, long long* matrix, __float128 angle);
		virtual __float128* rotateX(__float128* out, __int128* matrix, __float128 angle);
		virtual __float128* rotateX(__float128* out, float* matrix, __float128 angle);
		virtual __float128* rotateX(__float128* out, double* matrix, __float128 angle);
		virtual __float128* rotateX(__float128* out, __float128* matrix, __float128 angle);

		virtual float* rotateY(float* out, char* matrix, float angle);
		virtual float* rotateY(float* out, short* matrix, float angle);
		virtual float* rotateY(float* out, int* matrix, float angle);
		virtual float* rotateY(float* out, long long* matrix, float angle);
		virtual float* rotateY(float* out, __int128* matrix, float angle);
		virtual float* rotateY(float* out, float* matrix, float angle);
		virtual double* rotateY(double* out, char* matrix, double angle);
		virtual double* rotateY(double* out, short* matrix, double angle);
		virtual double* rotateY(double* out, int* matrix, double angle);
		virtual double* rotateY(double* out, long long* matrix, double angle);
		virtual double* rotateY(double* out, __int128* matrix, double angle);
		virtual double* rotateY(double* out, float* matrix, double angle);
		virtual double* rotateY(double* out, double* matrix, double angle);
		virtual __float128* rotateY(__float128* out, char* matrix, __float128 angle);
		virtual __float128* rotateY(__float128* out, short* matrix, __float128 angle);
		virtual __float128* rotateY(__float128* out, int* matrix, __float128 angle);
		virtual __float128* rotateY(__float128* out, long long* matrix, __float128 angle);
		virtual __float128* rotateY(__float128* out, __int128* matrix, __float128 angle);
		virtual __float128* rotateY(__float128* out, float* matrix, __float128 angle);
		virtual __float128* rotateY(__float128* out, double* matrix, __float128 angle);
		virtual __float128* rotateY(__float128* out, __float128* matrix, __float128 angle);

		virtual float* rotateZ(float* out, char* matrix, float angle);
		virtual float* rotateZ(float* out, short* matrix, float angle);
		virtual float* rotateZ(float* out, int* matrix, float angle);
		virtual float* rotateZ(float* out, long long* matrix, float angle);
		virtual float* rotateZ(float* out, __int128* matrix, float angle);
		virtual float* rotateZ(float* out, float* matrix, float angle);
		virtual double* rotateZ(double* out, char* matrix, double angle);
		virtual double* rotateZ(double* out, short* matrix, double angle);
		virtual double* rotateZ(double* out, int* matrix, double angle);
		virtual double* rotateZ(double* out, long long* matrix, double angle);
		virtual double* rotateZ(double* out, __int128* matrix, double angle);
		virtual double* rotateZ(double* out, float* matrix, double angle);
		virtual double* rotateZ(double* out, double* matrix, double angle);
		virtual __float128* rotateZ(__float128* out, char* matrix, __float128 angle);
		virtual __float128* rotateZ(__float128* out, short* matrix, __float128 angle);
		virtual __float128* rotateZ(__float128* out, int* matrix, __float128 angle);
		virtual __float128* rotateZ(__float128* out, long long* matrix, __float128 angle);
		virtual __float128* rotateZ(__float128* out, __int128* matrix, __float128 angle);
		virtual __float128* rotateZ(__float128* out, float* matrix, __float128 angle);
		virtual __float128* rotateZ(__float128* out, double* matrix, __float128 angle);
		virtual __float128* rotateZ(__float128* out, __float128* matrix, __float128 angle);
/*
